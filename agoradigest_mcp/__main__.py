"""Entrypoint for ``agoradigest-mcp`` console script.
...
Run directly: ``python -m agoradigest_mcp`` or via the installed
entrypoint ``agoradigest-mcp``.
"""
...
def main() -> int:
    ...
    try:
        ...
        print(f"agoradigest-mcp: fatal error: {e}", file=sys.stderr)
        return 1
